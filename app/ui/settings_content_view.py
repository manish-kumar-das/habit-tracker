...
from PySide6.QtWidgets import (
    ...
    QComboBox, QTimeEdit, QFileDialog, QMessageBox,
...
class SettingsContentView(QWidget):
    ...
    def setup_ui(self):
        ...
        # SECTION: Danger Zone
        self.content_layout.addSpacing(12)
        self.add_section_header("⚠️", "Danger Zone", "Irreversible actions", color="#DC2626")
        ...
        info_text.setFont(QFont("SF Pro Text", 13))
        ...
        try:
            ...
            for log in data.get('habit_logs', []):
                cursor.execute('''
                    ...
                    VALUES (?, ?, ?)
                ''', (log['habit_id'], log['completed_date'], 
                      log.get('created_at', datetime.now().strftime("%Y-%m-%d %H:%M:%S"))))
