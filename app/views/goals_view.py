...
class GoalCard(QFrame):
    ...
    def setup_ui(self):
        ...
        progress_bar.setFormat(
            f"{self.goal.current_value}/{self.goal.target_value} ({progress}%)"
        )
...
class GoalsView(QDialog):
    ...
    def setup_ui(self):
        ...
        header.setStyleSheet(
            "QFrame { background-color: #FFFFFF; border-bottom: 1px solid #E5E7EB; }"
        )
    ...
    def load_goals(self):
        ...
        if completed_goals:
            ...
            completed_label.setStyleSheet(
                "color: #059669; background: transparent; margin-top: 16px;"
            )
