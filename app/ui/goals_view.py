...
from PySide6.QtWidgets import (
    ...
    QComboBox, QSpinBox, QTextEdit, QDateEdit, QMessageBox
)
        ...
        progress_bar.setStyleSheet(f"""
            ...
            QProgressBar::chunk {{
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 {border_color}, stop:1 {border_color});
                border-radius: 8px;
            }}
        """)
...
class AddGoalDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.no_deadline_check = QLabel("✓ No deadline")
        self.no_deadline_check.setFont(QFont("Inter", 11))
        self.no_deadline_check.setStyleSheet("color: #6B7280; background: transparent;")
        self.no_deadline_check.setCursor(Qt.PointingHandCursor)
        self.no_deadline_check.mousePressEvent = lambda e: self.toggle_deadline()
        deadline_layout.addWidget(self.no_deadline_check)
    ...
    def toggle_deadline(self):
        ...
        self.use_deadline = not self.use_deadline
        self.no_deadline_check.setText("✓ No deadline" if not self.use_deadline else "☐ No deadline")
        self.deadline_edit.setEnabled(self.use_deadline)
