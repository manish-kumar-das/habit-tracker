...
class AnalyticsContentView(QWidget):
    ...
    def setup_ui(self):
        ...
        self.title_label.setStyleSheet(
            f"color: {text_primary}; background: transparent; border: none; padding-bottom: 4px;"
        )
        ...
        self.subtitle_label.setStyleSheet(
            f"color: {text_secondary}; background: transparent; border: none; padding-bottom: 2px;"
        )
    ...
    def apply_theme(self):
        ...
        if hasattr(self, 'title_label'):
            self.title_label.setStyleSheet(f"color: {text_primary}; background: transparent; border: none; padding-bottom: 4px;")
            
        if hasattr(self, 'subtitle_label'):
            self.subtitle_label.setStyleSheet(f"color: {text_secondary}; background: transparent; border: none; padding-bottom: 2px;")
    ...
    def load_analytics(self):
        ...
        if not habits:
            ...
            card_bg = colors.BG_CARD if is_dark else "#FFFFFF"
            ...
            text_primary = "#F3F4F6" if is_dark else "#111827"
            empty_title.setStyleSheet(f"color: {text_primary}; background: transparent; border: none;")
            ...
            text_secondary = "#9CA3AF" if is_dark else "#6B7280"
            empty_text.setStyleSheet(f"color: {text_secondary}; background: transparent; border: none;")
