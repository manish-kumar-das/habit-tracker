...
from PySide6.QtWidgets import (
    ...
    QPushButton, QScrollArea, QFrame, QWidget, QProgressBar, QMessageBox
)
...
class AchievementCard(QFrame):
    ...
    def setup_ui(self):
        ...
        icon_label.setStyleSheet(f"background: transparent; opacity: {'1.0' if self.achievement.is_unlocked else '0.3'};")
